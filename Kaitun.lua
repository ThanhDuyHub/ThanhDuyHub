...
SetText("NameHub", "<font color='#3b82f6'>!!</font> Khengie Slayer Hub / Kaitun <font color='#3b82f6'>!!</font>")
SetText("Credit", "<font color='#ef4444'>!!</font> Ui Kaitun <font color='#ef4444'>!!</font>")
...
WindUI:Notify({
    Title = "Khengie slayer Hub notify",
    Content = "Hopping...",
    Duration = 8,
